...
select * from registro_certificados;
...
BEGIN
  INSERT INTO registro_certificados (id_usuario, id_curso, data_emissao, codigo_validacao)
...
CALL
 EmitirCertificado(1, 1, 'CERTIF-ABC123');
